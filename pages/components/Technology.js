      ...
      <div className='mt-20 mb-32'>
          ...
          <div className='lg:grid lg:grid-cols-2 xl:grid-cols-4 lg:gap-10'>
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 sm:ml-72 md:ml-96 lg:ml-52 ml-48 z-20' src='/images/download.png' />
              ...
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 sm:ml-72 md:ml-96 lg:ml-52 ml-48 z-20' src='/images/search.png' />
              ...
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 sm:ml-72 md:ml-96 lg:ml-52 ml-48 z-20' src='/images/pdf.png' />
              ...
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 sm:ml-72 md:ml-96 lg:ml-52 ml-48 z-20' src='/images/csv.png' />
