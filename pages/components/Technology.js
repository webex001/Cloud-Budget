      ...
      <div className='mt-20 mb-32'>
          ...
          <div className='flex-col justify-evenly'>
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 lg:ml-32 ml-48 z-20' src='/images/download.png' />
              ...
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 lg:ml-32 ml-48 z-20' src='/images/search.png' />
              ...
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 lg:ml-32 ml-48 z-20' src='/images/pdf.png' />
              ...
              <div className='mt-20'>
                    ...
                    <img className='absolute -mt-12 lg:ml-32 ml-48 z-20' src='/images/csv.png' />
