  ...
  return(
      <div className='flex-col justify-evenly mt-24 mb-24 sm:flex-wrap'>
          <div className=''>
            ...
            <p className='font-normal text-sm sm:text-base sm:text-center leading-5 text-left m-3'>Questions or concerns? Just fill out the form below and our support <br/> team will get back to you within 24 hours</p>
          </div>
          <div>
            <div className='flex-col sm:mt-10 sm:ml-16'>
            ...
            <div className='mt-5 sm:mt-10 sm:ml-16'>
