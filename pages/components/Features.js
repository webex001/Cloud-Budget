    ...
    <h2 className='text-center text-4xl font-semibold mb-10'>Features</h2>
      <div className=' justify-evenly flex-col'>
          <div className="mb-44">
              ...
              <div className='bg-white shadow-lg rounded p-5 z-40 absolute -mt-24 w-72 ml-6'>
          ...
          <div className="mb-44">
              ...
              <div className='bg-white shadow-lg rounded w-72 ml-6 p-5 z-20 absolute -mt-24'>
          ...
          <div className="mb-44">
              ...
              <div className='bg-white shadow-lg rounded absolute -mt-24 w-72 ml-6 p-5 z-20'>
