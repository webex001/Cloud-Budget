...
const StayFocus = () => {
  return(
        <div className='flex-col lg:flex md:flex-nowrap justify-evenly bg-red-500 pt-20 pb-20 sm:flex-wrap'>
            <div className='text-white'>
                <h4 className='lg:text3xl text-4xl text-center font-bold mt-10'>Stay focused on saving <br />money</h4>
                <p className='lg:text-sm ml-3 lg:text-center text-sm font-normal mt-10'>
                ...
                <div className='flex mt-8 mb-10 ml-4 justify-center'>
            ...
            <div className='m-3 sm:ml-24 sm:mt-10'>
