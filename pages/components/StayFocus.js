  ...
  return(
        <div className='flex-col justify-evenly bg-red-500 pt-20 pb-20 sm:flex-wrap'>
            <div className='text-white'>
                <h4 className='text3xl sm:text-5xl  text-center font-semibold mt-10'>Stay focused on saving <br />money</h4>
                <p className='text-sm ml-3 sm:text-center sm:text-base font-normal mt-10'>
                ...
                <div className='flex mt-8 mb-10 ml-4 sm:justify-center'>
